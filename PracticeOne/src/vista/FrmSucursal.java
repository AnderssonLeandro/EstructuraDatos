...
public class FrmSucursal extends javax.swing.JDialog {
    ...
    SucursalControl controlador = new SucursalControl();
    ...
    private void guardar() throws IOException {
        ...
        historial.guardar("Se ha guardado una sucursal "+ LocalTime.now());
        clear();
    }

    private void mostrarVentas() throws VacioException, PosicionException {
        int pos = tblSucursales.getSelectedRow();

        if (pos >= controlador.getSucursales().size()) {
            throw new VacioException("La Sucursal no existe");
        }

        if (pos >= 0) {
            controlador.setSucursal(modelo.getDato().get(pos));
            new FrmVentas(null, true, controlador).setVisible(true);
            clear();
        } else {
            throw new PosicionException("Seleccione una sucursal");
        }
